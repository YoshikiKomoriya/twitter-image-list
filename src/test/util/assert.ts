 ...
 * @param value 検証したい値
 */
const assertIsTextArea: assertGenericsType<HTMLTextAreaElement> = (
  value: any,
) =>
  assertGenerics<HTMLTextAreaElement>(
    value,
    (value) => value instanceof HTMLTextAreaElement,
  )

export { assertIsTextArea }
